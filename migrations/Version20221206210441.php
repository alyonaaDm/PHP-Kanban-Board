 ...
 */
final class Version20221206210441 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE condition (id INT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
